...
function LivePill({}: Props) {
  ...
  return (
    <div className="px-2 py-3 md:px-4 md:py-4 relative w-full space-y-2 backdrop-blur-md bg-green-50/60 rounded-md border border-gray-300 overflow-hidden">
        ...
        <div className="w-full md:mt-10 space-y-2">
            <div className="relative h-full w-full flex items-center justify-between space-x-2">
                ...
                <div className="px-1 md:px-1.5 py-1 absolute left-1/2 top-[65%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center -skew-x-6 rounded-sm bg-slate-100 font-bold text-[0.6rem] md:text-[0.8rem] text-gray-500">4</div>
                <div className="px-1 md:px-1.5 py-1 absolute left-1/2 top-[65%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center -skew-x-6 rounded-sm bg-slate-100 font-bold text-[0.6rem] md:text-[0.8rem] text-gray-500">0</div>
