...
function FixturePill({ row }: Props) {
  ...
  return (
    <div className="relative overflow-hidden p-2 md:p-4 w-full rounded border bg-slate-100 flex flex-col md:flex-row items-center justify-start md:justify-center space-y-2 md:space-y-0 md:space-x-5">
        ...
        <div className="hidden md:flex px-1.5 py-0.5 text-[0.6em] text-gray-400 font-semibold uppercase border border-gray-400 rounded-md tracking-wider">{row.kickstatus}</div>
